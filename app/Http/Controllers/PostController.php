...
class PostController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('post.index')->with('success','post berhasil dihapus(silahkan cek trashed post)');
    }
    ...
    public function restore($id){
        ...
        $post->restore();
        return redirect()->back()->with('success','post berhasil di pulihkan silahkan cek di list post');
    }
